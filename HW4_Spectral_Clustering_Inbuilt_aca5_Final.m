...
% (Everything same, only difference is aca5 is used now)





X = readmatrix('X_5.csv');             
y_true = readmatrix('s_5.csv');
...
writematrix(error_matrix,'Error_Matrix_aca5.csv')                  % storing to .csv
